...
function new_tr( goal ) {
	...
	result = $( "<tr class=\""+tr_class+"\"><td><span class=\"id\">"+goal.id+"</span><span>"+goal.description+"</span></td><td>"+goal.pn+"</td><td>"+goal.gewicht+"</td><td>"+goal.inventory+"</td><td>"+goal.target+"</td><td>"+count_field+"</td><td>"+goal.lagerort+"</td><td>"+rfid_field+"</td></tr>" );
